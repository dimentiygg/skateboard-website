...
const VERTICAL_LINE_CLASSES = "absolute top-0 h-full stroke-2 text-stone-300 transition-colors group-hover:text0stone-400"

const HORIZONTAL_LINE_CLASSES = "-mx-8 troke-2 text-stone-300 transition-colors group-hover:text0stone-400"
